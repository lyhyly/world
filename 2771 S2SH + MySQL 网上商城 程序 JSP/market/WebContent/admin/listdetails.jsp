			...
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<s:iterator value="list" id="list">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="center"><s:property value="goodsid" /></td>
							<td align="center"><s:property value="num" /></td>
							<td align="center"><s:property value="price" /></td>
							<td align="center"><s:a
									href="details/getDetailsById.action?id=%{detailsid}">编辑</s:a>|<s:a
									href="details/deleteDetails.action?details.detailsid=%{detailsid}"
