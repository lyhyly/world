		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">商品小类信息列表</td>
					</tr>
					<tr align="center">
					...
					<s:iterator value="list" id="list">
						<tr align="center" bgcolor="#FFFFFF">
							<td align="center"><s:property value="bcateid" /></td>
							<td align="center"><s:property value="scatename" /></td>
						</tr>
					</s:iterator>
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form action="scate/queryScateByCond.action"
								name="myform" method="post">
								查询条件<select name="cond" style="width: 100px"><option
										value="bcateid">按商品大类查询</option>
									<option value="scatename">按商品小类查询</option></select>关键字<input type="text"
